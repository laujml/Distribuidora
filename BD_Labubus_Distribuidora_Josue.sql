...
(1,'Wendy Sofia Rodriguez Salazar','analopez@correo.com','12345678','calle2'),
...
CREATE TABLE `Pedido` (
  ...
  `pendiente_pagar` decimal(6,2) DEFAULT 0.00,
...
CREATE TABLE `Proveedor` (
  ...
  `P_Contacto` varchar(55) NOT NULL,
...
-- Dump completed on 2025-07-18 16:00:09
