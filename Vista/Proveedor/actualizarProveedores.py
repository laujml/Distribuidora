...
class ActualizarProveedores(QWidget):
    ...
    def initUI(self):
        ...
        titulo_ventana = QLabel("Actualizar proveedores")
        ...
        btn_actualizar.setFont(QFont("Poppins", 11, QFont.Weight.Bold))
        ...
        btn_otro = QPushButton("Actualizar otro proveedor")
    ...
    def actualizar_proveedor(self):
        ...
        confirm = QMessageBox.question(self, "Confirmar actualización", f"¿Seguro que deseas actualizar el proveedor con ID {id_proveedor}?", QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
        if confirm == QMessageBox.StandardButton.Yes:
            ok, msg = self.controller.actualizar_proveedor(id_proveedor, proveedor, p_contacto, correo, telefono, direccion)
            self.mostrar_popup(msg, ok)
