...
from PyQt6.QtWidgets import (
    ...
    QLabel, QMessageBox, QStackedWidget, QComboBox
)
...
class VentanaProductosPrincipal(QWidget):
    ...
    def initUI(self):
        ...
        botones = [
            ...
            ("Editar producto", lambda: self.stacked_widget.setCurrentIndex(3)),
...
if __name__ == "__main__":
    ...
    ventana_editar = BaseProductoVentana(stack, "Editar Producto", "buscar", "Buscar", mostrar_buscar=False)
    ...
    stack.addWidget(ventana_editar)
    stack.addWidget(ventana_actualizar)

    stack.setFixedSize(500, 600)
    stack.show()
    sys.exit(app.exec())
